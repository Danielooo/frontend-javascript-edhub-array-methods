...
// Test "First commit"
// Test "Commit feature/uitwerkingen"
...
const filteredYears = inventors.map((inventor) => {
...
const longToShortLife = inventors.sort((a, b) => (b.passed - b.year) - (a.passed - a.year));

console.log('\nlongToShortLife: ');
console.log(longToShortLife);
...
const foundInventor = inventors.find((inventor) => {return inventor.last === 'Edison'});
